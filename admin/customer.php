...
// Duy trì trạng thái (tìm kiếm,sắp xếp, phân trang) trên url edit, delete, copy, repair
// $url='';
...
// Thực hiện truy vấn
$total_customer = customerGetTotal($filter_data);
...
// 		'edit'        => "/admin/customer-edit.php?customer_id=".$result['customer_id'].$url
		'edit'        => "/admin/customer-edit.php?customer_id=".$result['customer_id']
	);
}
...
paginate($total_customer, $page,settings('config_limit_admin'), "/admin/customer.php".$url);
