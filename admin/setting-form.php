...
if (isset($_POST['categories_featured_limit'])) {
    $categories_featured_limit = $_POST['categories_featured_limit'];
} else {
    $categories_featured_limit = settings('categories_featured_limit');
}
