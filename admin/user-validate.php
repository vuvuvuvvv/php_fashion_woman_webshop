 ...
 * Copyright C2009G
 *
 * Các hàm kiểm duyệt tính hợp lệ của dữ liệu nhân viên quản trị.
 * Chú Ý: sử dụng các biến global $error_field sẽ tốt hơn nhiều so với $_SESSION['ERROR_TEXT'].
 * Biến session rất hay bị chết bên view *.phtml
 */
// Cấu hình hệ thống:
...
function validateAdd()
{
	...
	if ($_SESSION['USR_USERNAME'] != "admin")
	{
		...
		$error_username         = "Bạn không có quyền thêm mới người dùng trên hệ thống ! (chỉ admin mới có quyền)";
