      ...
      <div class="panel-body">
        <form action="<?php echo $url_action; ?>" method="post" enctype="multipart/form-data" id="form-banner-image" class="form-horizontal">
		  <ul class="nav nav-tabs">
            ...
            <li class=""><a href="#tab-data" data-toggle="tab">Dữ Liệu Khác</a></li>
          </ul>
          ...
          <div class="tab-content">
          	...
          	<div class="tab-pane fade" id="tab-data">
		          ...
		          <div class="form-group">
		            <label class="col-sm-2 control-label" for="input-link"><span data-toggle="tooltip" title="Đường dẫn đến nội dung liên quan, mà không gắn id">Link</span></label>
		            <div class="col-sm-10">
		          ...
		          <div class="form-group">
	                <label class="col-sm-2 control-label" for="input-price"><span data-toggle="tooltip" title="Giá tiền cho sản phẩm trên slide (nếu có)">Giá Tiền</span></label>
	                <div class="col-sm-10">
	                  <input type="text" name="price" value="<?php echo $banner_image_price; ?>" placeholder="Giá tiền cho sản phẩm trên slide (nếu có)" id="input-price" class="form-control" />
	                </div>
	              </div>
          	</div>
          </div>
