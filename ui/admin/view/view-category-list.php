          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-name">Tên Loại</label>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left">                    
                     <a href="<?php echo $sort_name; ?>" class="<?php if ($sort == 'cd.name') { echo strtolower($order); }?>">Tên Loại Sản Phẩm</a>
                  </td>
                  ...
                  <td class="text-right"><?php  ?>
                     <a href="<?php echo $sort_sort_order; ?>" class="<?php if ($sort == 'cd.sort_order') { echo strtolower($order); } ?>">Thứ Tự</a>
                  </td>
                  <td class="text-left">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $category['status_text']; ?></td>
                  <td class="text-left"><?php echo $category['featured_text']; ?></td>
                  <td class="text-left"><?php echo $category['top_text']; ?></td>
                  
                  <td class="text-right"><?php echo $category['sort_order']; ?></td>
                  <td class="text-left"><?php echo $category['date_added_text']; ?></td>
                ...
                <?php } ?>
                <tr>
                  <td class="text-center" colspan="10"><?php echo "Tìm thấy {$category_total} loại."; ?></td>
                </tr>
                <?php } else { ?>
                <tr>
...
$('#button-filter').on('click', function() {
	...
	// Tìm kiếm theo trạng thái của loại (duyệt/không duyệt)
	...
	// Tìm kiếm theo tính nổi bật (có/không) trên thẻ select của loại
	...
	// Tìm kiếm các loại thuộc dạng Top (được đưa thẳng lên Menu Top nằm ngang của trang chủ)
