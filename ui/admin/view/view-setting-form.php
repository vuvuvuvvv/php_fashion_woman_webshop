  ...
  <div class="page-header">
    <div class="container-fluid">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="/admin/setting-edit.php">Cài Đặt Cấu Hình Hệ Thống</a></li>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
      ...
      <div class="panel-body">
        <form action="<?php echo $url_action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#tab-general" data-toggle="tab">Thông Tin Cửa Hàng</a></li>
            <li><a href="#tab-option" data-toggle="tab">Giới Hạn</a></li>
            <li><a href="#tab-option-product" data-toggle="tab">Tùy Chọn Sản Phẩm</a></li>
            <!--  li><a href="#tab-option-blog" data-toggle="tab">Tùy Chọn Bài Viết</a></li -->
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
			  ...
			  <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-html_google_map_embed"><span data-toggle="tooltip" title="Sửa các thuộc tính width, height, style để bản đồ hiển thị phù hợp với bố cục trang chủ">Bản Đồ</span></label>
                <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-categories_featured_limit"><span data-toggle="tooltip" title="Giới hạn số loại nổi bật (Featured Categories)">Số Loại Nổi Bật</span></label>
                  <div class="col-sm-10">
                    <input type="text" name="categories_featured_limit" value="<?php echo $categories_featured_limit; ?>" placeholder="Số loại nổi bật" id="input-categories_featured_limit" class="form-control" />
                    <?php if ($error_categories_featured_limit) { ?>
                    <div class="text-danger"><?php echo $error_categories_featured_limit; ?></div>
                    <?php } ?>
                  </div>
                </div>
            ...
            <div class="tab-pane" id="tab-option-product">
            	<div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-catalog-limit"><span data-toggle="tooltip" title="XXX...">Thông Tin XXX</span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_xxx" value="<?php echo $config_xxx; ?>" placeholder="Default Items Per Page" id="input-catalog-limit" class="form-control" />
                    <?php if ($error_xxx) { ?>
                    <div class="text-danger"><?php echo $error_xxx; ?></div>
                    <?php } ?>
                  </div>
                </div>
            </div>
            ...
            <!-- 
            <div class="tab-pane" id="tab-option-blog">
            	<div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-catalog-limit"><span data-toggle="tooltip" title="XXX...">Thông Tin XXX</span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_xxx" value="<?php echo $config_xxx; ?>" placeholder="Default Items Per Page" id="input-catalog-limit" class="form-control" />
