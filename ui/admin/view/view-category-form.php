  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="/admin/category.php" data-toggle="tooltip" title="Hủy" class="btn btn-default"><i class="fa fa-reply"></i></a>
      </div>
      <ul class="breadcrumb">
          ...
          <div class="tab-content">
            <div class="tab-pane active in" id="tab-general">
              <div class="tab-pane" id="language">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-status">Duyệt</label>
                  <div class="col-sm-10">
            ...
            <div class="tab-pane fade" id="tab-data">
             ...
             -->
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sort-order">Số Cột</label>
                <div class="col-sm-10">
                  <input type="text" name="column" value="<?php echo $category_column; ?>" placeholder="Số cột phân bổ cho menu con" id="input-sort-order" class="form-control" />
                </div>
              </div>
