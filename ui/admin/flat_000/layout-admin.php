			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					<a href="/admin.php" class="navbar-brand" title="Trang Quản Trị Của Nội Bộ Nhân Viên">
						<!-- Admin Panel -->
						<img src="<?php echo web_logo_url(); ?>" width="32" height="32" style="display:inline" />Admin Backend
					</a>
				...
				<div data-scrollbar="true" data-height="100%" data-init="true" style="overflow: hidden; width: auto; height: 100%;">
					...
					<ul class="nav">
						<li class="nav-profile">
							<div class="image">
								<a href="/admin/user-edit.php?user_id=<?php echo user_id(); ?>"><img src="<?php echo user_image(); ?>" alt=""></a>
							</div>
							<div class="info">
