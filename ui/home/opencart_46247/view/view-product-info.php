                    ...
                    <div class="row">
                        <div class="span9  " id="content">
                            <div class="breadcrumb">
                                <a href="/home.php">Home</a> » <a href="<?php echo $product_info['href']; ?>" class="last"><?php echo $product_info['name'];?></a>
                            </div>
                                        ...
                                        <div id="default_gallery" class="left spacing">
                                            ...
                                            <div class="zoom-top">
                                                <a href="<?php echo $image['popup']?>" title="<?php echo $product_info['name'];?>" data-gal="prettyPhoto[gallery1]">
                                                    <img src="" title="<?php echo $image['thumb'];?>" alt="<?php echo $product_info['name'];?>">
                                                </a>
                                            </div>
                                            <?php }?>
                                            ...
                                            <div class="image-additional">
                                            	<ul id="image-additional" style="width: 1290%; position: relative; transition-duration: 0s; transform: translate3d(-240px, 0px, 0px);">
                                                    ...
                                                    <li style="float: left; list-style: outside none none; position: relative; width: 70px; margin-right: 10px;">
                                                    	<a href="<?php echo $image['popup']?>" title="<?php echo $product_info['name'];?>" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '<?php echo $image['popup']?>' ">
