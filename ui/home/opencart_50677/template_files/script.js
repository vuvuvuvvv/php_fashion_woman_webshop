...
$(document).ready(function() {
    ...
    // Đoạn mã này chỉ chịu trách nhiệm trượt đi trượt lại slide
    // các ảnh chi tiết sản phẩm (http://localhost:82/web/product/product-detail.php?product_id=40)
    // hoàn toàn ko liên quan gì đến đoạn mã elevatezoom bên dưới.
    // Chẳng qua elevatezoom lấy khối #image-additional làm gallery nên mới dễ
    // bị hiểu nhầm là 2 thư viện jquery plugin này tương tác/kết hợp với nhau.
