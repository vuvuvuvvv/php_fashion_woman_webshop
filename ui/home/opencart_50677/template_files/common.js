$(document).ready(function() {
	...
	// hàm search() khai báo bên trong /web/themes/home/common.js
	// Nếu người dùng nhấp chuột vào nút tìm kiếm
	// thì gọi hàm search()
	$('.button-search').bind('click', search);
	
	// hoặc nếu người dùng nhập từ khóa xong và ấn phím
	// 'Enter' (mã 13) thì cũng gọi hàm search()
