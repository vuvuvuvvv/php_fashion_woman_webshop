                                        ...
                                        <div class="right">
								            ...
								            <form id="login" action="/login.php" method="post" enctype="multipart/form-data">
                                                <div class="content">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="padd-form control-label" for="password">Password:</label>
                                                        <div class="controls">
                                                            <input class="q1 margen-bottom" name="password" value="<?php echo $_SESSION['FAILED_PASSWORD'];?>" type="password">
                                                        </div>
                                                    </div>
                                                    <div class="login-buttons">
                                                        <a onclick="$('#login').submit();" class="button-cont-right">Login<i class="icon-circle-arrow-right"></i></a>
